...
Текущий ориентир для типизации — архив OpenAPI-схем [`max-messenger-bot/max-bot-api-schemas`](https://github.com/max-messenger-bot/max-bot-api-schemas), файл `schema_2026_06_02`, версия Bot API `0.0.32`.
